...
import { Vec2, v, vfp, assertNever, deepCopy, OneOrMore, iterate, el } from "../isomorphism/utils";
...
import { appendDescriptorsLeft, scale2 } from "../isomorphism/transformHelpers";
