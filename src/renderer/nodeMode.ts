import { refleshContent, sendBackToEditor, contentChildrenComponent, informationRequest } from "./main";
import { SvgTag } from "../isomorphism/svg";
import { svgPathManager } from "../isomorphism/pathHelpers";
import { Vec2, v, vfp, OneOrMore } from "../isomorphism/utils";
import { PathCommand, ParsedElement } from "../isomorphism/svgParser";
import { Mode } from "./abstractMode";
import { applyToPoint, inverse, toString } from "transformation-matrix";
import { shaper } from "./shapes";
import { scale2 } from "../isomorphism/transformHelpers";
