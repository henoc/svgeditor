...
var _user$project$Combinators$skipwhitespace = function (input) {
	skipwhitespace:
	while (true) {
		var firstStr = A2(_elm_lang$core$String$left, 1, input.data);
		var spaces = A2(_elm_lang$core$List$map, _elm_lang$core$String$fromChar, input.whitespace);
		if (A2(
			_elm_lang$core$List$any,
			function (x) {
				return _elm_lang$core$Native_Utils.eq(x, firstStr);
			},
			spaces)) {
...
var _user$project$Combinators$resultMap = F2(
	function (fn, p) {
		var _p0 = p;
		if (_p0.ctor === 'ParseSuccess') {
			return A2(
				_user$project$Combinators$ParseSuccess,
				fn(_p0._0),
				_p0._1);
		} else {
			return A2(_user$project$Combinators$ParseFailure, _p0._0, _p0._1);
		}
	});
var _user$project$Combinators$andThen = F3(
	function (p, q, input) {
		var _p1 = p(input);
		if (_p1.ctor === 'ParseSuccess') {
			return A2(
				_user$project$Combinators$resultMap,
				function (r2) {
					return {ctor: '_Tuple2', _0: _p1._0, _1: r2};
				},
				q(_p1._1));
		} else {
			return A2(_user$project$Combinators$ParseFailure, _p1._0, input);
		}
	});
...
var _user$project$Combinators$regexParser = F2(
	function (str, rawInput) {
		var regex = _elm_lang$core$Regex$regex(str);
		var input = _user$project$Combinators$skipwhitespace(rawInput);
		var result = A3(
			_elm_lang$core$Regex$find,
			_elm_lang$core$Regex$AtMost(1),
		...
		if (_p2.ctor === '[]') {
			...
			var _p3 = _p2._0;
			return (!_elm_lang$core$Native_Utils.eq(_p3.index, 0)) ? A2(
				_user$project$Combinators$ParseFailure,
				A2(_elm_lang$core$Basics_ops['++'], 'input doesn\'t match with ', str),
				input) : A2(
				_user$project$Combinators$ParseSuccess,
				...
				_elm_lang$core$Native_Utils.update(
					input,
					{position: input.position + _p3.index}));
		}
	});
var _user$project$Combinators$or = F3(
	function (p, q, input) {
		...
		if (_p4.ctor === 'ParseSuccess') {
			return A2(_user$project$Combinators$ParseSuccess, _p4._0, _p4._1);
		} else {
			var _p5 = q(input);
			if (_p5.ctor === 'ParseSuccess') {
				return A2(_user$project$Combinators$ParseSuccess, _p5._0, _p5._1);
			} else {
				return A2(_user$project$Combinators$ParseFailure, _p5._0, input);
			}
		}
	});
...
var _user$project$Combinators$map = F3(
	function (fn, p, input) {
		...
		if (_p7.ctor === 'ParseSuccess') {
			...
			return A2(_user$project$Combinators$ParseFailure, _p7._0, _p7._1);
		}
	});
...
var _user$project$Combinators$rep1 = F2(
	function (p, input) {
		...
		if (_p13.ctor === 'ParseSuccess') {
			return A2(
				_user$project$Combinators$ParseSuccess,
				{ctor: '::', _0: _p13._0._0, _1: _p13._0._1},
				_p13._1);
		} else {
			return A2(_user$project$Combinators$ParseFailure, _p13._0, _p13._1);
		}
	});
var _user$project$Combinators$rep1sep = F3(
	function (p, s, input) {
		...
		if (_p14.ctor === 'ParseSuccess') {
			return A2(
				_user$project$Combinators$ParseSuccess,
				{ctor: '::', _0: _p14._0._0, _1: _p14._0._1},
				_p14._1);
		} else {
			return A2(_user$project$Combinators$ParseFailure, _p14._0, _p14._1);
		}
	});
...
var _user$project$Vec2_ops = _user$project$Vec2_ops || {};
_user$project$Vec2_ops['/#'] = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
...
var _user$project$Types$Ellipse = function (a) {
	return {ctor: 'Ellipse', _0: a};
};
...
var _user$project$Types$NoSelect = {ctor: 'NoSelect'};
var _user$project$Types$OnSelect = F3(
	function (a, b, c) {
		return {ctor: 'OnSelect', _0: a, _1: b, _2: c};
	});
...
var _user$project$Types$MouseUp = function (a) {
...
var _user$project$Utils$ratio = F2(
	function (next, previous) {
		var r = A2(_user$project$Vec2_ops['/#'], next, previous);
		var r2 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$isNaN(
				_elm_lang$core$Tuple$first(r)) ? 1.0 : _elm_lang$core$Tuple$first(r),
			_1: _elm_lang$core$Basics$isNaN(
				_elm_lang$core$Tuple$second(r)) ? 1.0 : _elm_lang$core$Tuple$second(r)
		};
		var r3 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$isInfinite(
				_elm_lang$core$Tuple$first(r2)) ? 1.0 : _elm_lang$core$Tuple$first(r2),
			_1: _elm_lang$core$Basics$isInfinite(
				_elm_lang$core$Tuple$second(r2)) ? 1.0 : _elm_lang$core$Tuple$second(r2)
		};
		return r3;
	});
				...
				if (filter(_p3)) {
					...
					if (_p2.ctor === '::') {
						return {
							ctor: '::',
							_0: _p2._0,
							_1: A3(_user$project$Utils$replace, filter, _p2._1, _p4)
						};
					} else {
						var _v3 = filter,
							_v4 = {ctor: '[]'},
					...
					return {
						ctor: '::',
						_0: _p3,
						_1: A3(_user$project$Utils$replace, filter, replacer, _p4)
					};
				}
			} else {
				return {ctor: '[]'};
...
var _user$project$Utils$onItemMouseDown = function (tagger) {
	var clientPos = A3(
		_elm_lang$core$Json_Decode$map2,
		F2(
			function (x, y) {
		...
		_user$project$Utils$clientX,
		_user$project$Utils$clientY);
	var mouseEvent = A3(
		_elm_lang$core$Json_Decode$map2,
		F2(
			function (x, y) {
...
var _user$project$Utils$getById = F2(
	function (ident, model) {
		var loop = function (lst) {
			...
			while (true) {
				...
				if (_p6.ctor === '::') {
					var _p7 = _p6._0;
					if (_elm_lang$core$Native_Utils.eq(_p7.id, ident)) {
		...
		if (_p8.ctor === '::') {
			if (_p8._0.ctor === 'Just') {
				return {
					ctor: '::',
					_0: _p8._0._0,
					_1: _user$project$Utils$flatten(_p8._1)
				};
			} else {
				var _v10 = _p8._1;
				lst = _v10;
...
var _user$project$Utils$init = function (lst) {
	var len = _elm_lang$core$List$length(lst);
	return A2(_elm_lang$core$List$take, len - 1, lst);
};
var _user$project$Utils$last = function (lst) {
	var len = _elm_lang$core$List$length(lst);
	var _p9 = A2(_elm_lang$core$List$drop, len - 1, lst);
...
var _user$project$Shape$scale = F2(
	function (ratio, elem) {
		var scaled = _elm_lang$core$Native_Utils.update(
			elem,
			{
				shape: function () {
					var _p2 = elem.shape;
...
var _user$project$Shape$scale2 = F3(
	function (offset, ratio, elem) {
		var centerScaled = A2(_user$project$Shape$scale, ratio, elem);
		var fixedPoint = A2(_user$project$Shape$getOffsettedCenter, offset, elem);
		return A3(
			_user$project$Shape$setOffsettedCenter,
			fixedPoint,
...
var _user$project$ShapeList$translate = F2(
	function (delta, elems) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Shape$translate(delta),
			elems);
	});
var _user$project$ShapeList$merge = function (boxes) {
	merge:
	while (true) {
		var _p0 = boxes;
		if (_p0.ctor === '::') {
					...
					_0: {
						leftTop: {
							...
							_0: A2(
								...
								_elm_lang$core$Tuple$first(_p1.leftTop),
								_elm_lang$core$Tuple$first(_p2.leftTop)),
							_1: A2(
								_elm_lang$core$Basics$min,
								_elm_lang$core$Tuple$second(_p1.leftTop),
								_elm_lang$core$Tuple$second(_p2.leftTop))
						},
						rightBottom: {
							ctor: '_Tuple2',
							_0: A2(
								_elm_lang$core$Basics$max,
								_elm_lang$core$Tuple$first(_p1.rightBottom),
								_elm_lang$core$Tuple$first(_p2.rightBottom)),
							_1: A2(
								_elm_lang$core$Basics$max,
								_elm_lang$core$Tuple$second(_p1.rightBottom),
								_elm_lang$core$Tuple$second(_p2.rightBottom))
						}
					},
					_1: _p0._1._1
				};
...
var _user$project$ShapeList$getMergedBBox = function (lst) {
	return _user$project$ShapeList$merge(
		A2(_elm_lang$core$List$map, _user$project$Shape$getBBox, lst));
};
var _user$project$ShapeList$getCenter = function (elems) {
	var box = _user$project$ShapeList$getMergedBBox(elems);
	return A2(
		_user$project$Vec2_ops['/#'],
		A2(_user$project$Vec2_ops['+#'], box.leftTop, box.rightBottom),
		{ctor: '_Tuple2', _0: 2, _1: 2});
};
var _user$project$ShapeList$setCenter = F2(
	function (cent, elems) {
		var oldCenter = _user$project$ShapeList$getCenter(elems);
		var delta = A2(_user$project$Vec2_ops['-#'], cent, oldCenter);
		return A2(_user$project$ShapeList$translate, delta, elems);
	});
var _user$project$ShapeList$getOffsettedCenter = F2(
	function (offset, elems) {
		return A2(
			_user$project$Vec2_ops['+#'],
			offset,
			_user$project$ShapeList$getCenter(elems));
	});
var _user$project$ShapeList$setOffsettedCenter = F3(
	function (offsettedCent, offset, elems) {
		var oldOffsettedCenter = A2(_user$project$ShapeList$getOffsettedCenter, offset, elems);
		var delta = A2(_user$project$Vec2_ops['-#'], offsettedCent, oldOffsettedCenter);
		return A2(_user$project$ShapeList$translate, delta, elems);
	});
var _user$project$ShapeList$scale2 = F3(
	function (offset, ratio, elems) {
		var centerScaled = A2(
			_elm_lang$core$List$map,
			_user$project$Shape$scale(ratio),
			elems);
		var fixedPoint = A2(_user$project$ShapeList$getOffsettedCenter, offset, elems);
		return A3(
			_user$project$ShapeList$setOffsettedCenter,
			fixedPoint,
			A2(_user$project$Vec2_ops['*#'], offset, ratio),
			centerScaled);
	});
var _user$project$ShapeList$scale = F2(
	function (ratio, elems) {
		var scaled = A2(
			_elm_lang$core$List$map,
			_user$project$Shape$scale(ratio),
			elems);
		var center = _user$project$ShapeList$getCenter(elems);
...
var _user$project$ViewBuilder$buildVertexes = function (model) {
	...
	var box = _user$project$ShapeList$getMergedBBox(svglst);
	var left = _elm_lang$core$Tuple$first(box.leftTop);
	var top = _elm_lang$core$Tuple$second(box.leftTop);
	var right = _elm_lang$core$Tuple$first(box.rightBottom);
	var bottom = _elm_lang$core$Tuple$second(box.rightBottom);
	var positions = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: left, _1: top},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: (left + right) / 2, _1: top},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: right, _1: top},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: left, _1: (top + bottom) / 2},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: right, _1: (top + bottom) / 2},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: left, _1: bottom},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: (left + right) / 2, _1: bottom},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: right, _1: bottom},
									_1: {ctor: '[]'}
								}
							}
						}
	...
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$List$length(svglst),
		0) ? {ctor: '[]'} : A3(
		_elm_lang$core$List$map2,
		F2(
			function (pos, anti) {
...
var _user$project$Parsers$getAttr = F2(
	function (name, attrs) {
		var attrMap = _elm_lang$core$Dict$fromList(attrs);
		return A2(_elm_lang$core$Dict$get, name, attrMap);
	});
var _user$project$Parsers$stylePairParser = A2(
	_user$project$Combinators$andThen,
	_user$project$Combinators$regexParser('[^\\s:]+'),
	_user$project$Combinators$regexParser('[^\\s;]+'));
var _user$project$Parsers$styleParser = A2(
	_user$project$Combinators$map,
	_elm_lang$core$Dict$fromList,
	_user$project$Combinators$rep(_user$project$Parsers$stylePairParser));
var _user$project$Parsers$getStyleAttr = F2(
	function (name, attrs) {
		var _p0 = A2(_user$project$Parsers$getAttr, 'style', attrs);
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			var _p1 = _user$project$Parsers$styleParser(
				_user$project$Combinators$normalInput(_p0._0));
			if (_p1.ctor === 'ParseSuccess') {
				return A2(_elm_lang$core$Dict$get, name, _p1._0);
			} else {
				return _elm_lang$core$Maybe$Nothing;
			}
		}
	});
var _user$project$Parsers$convertNode = function (node) {
	var _p2 = node;
	switch (_p2.ctor) {
		case 'Text':
			return _elm_lang$core$Maybe$Nothing;
		...
		default:
			...
			switch (_p3) {
				case 'svg':
					var subElems = _user$project$Utils$flatten(
						A2(_elm_lang$core$List$map, _user$project$Parsers$convertNode, _p5));
					return _elm_lang$core$Maybe$Just(
						{
				...
				case 'rect':
					var hStr = A2(
						_elm_lang$core$Maybe$withDefault,
						'0',
						A2(_user$project$Parsers$getAttr, 'height', _p4));
					var h = A2(
						_elm_lang$core$Result$withDefault,
						0,
						_elm_lang$core$String$toFloat(hStr));
					var wStr = A2(
						_elm_lang$core$Maybe$withDefault,
						'0',
						A2(_user$project$Parsers$getAttr, 'width', _p4));
					var w = A2(
						_elm_lang$core$Result$withDefault,
						0,
						_elm_lang$core$String$toFloat(wStr));
					var yStr = A2(
						_elm_lang$core$Maybe$withDefault,
						'0',
						A2(_user$project$Parsers$getAttr, 'y', _p4));
					var y = A2(
						_elm_lang$core$Result$withDefault,
						0,
						_elm_lang$core$String$toFloat(yStr));
					var xStr = A2(
						_elm_lang$core$Maybe$withDefault,
						'0',
						A2(_user$project$Parsers$getAttr, 'x', _p4));
					var x = A2(
						_elm_lang$core$Result$withDefault,
						0,
						_elm_lang$core$String$toFloat(xStr));
					return _elm_lang$core$Maybe$Just(
						{
							style: {
								fill: A2(_user$project$Parsers$getStyleAttr, 'fill', _p4),
								stroke: A2(_user$project$Parsers$getStyleAttr, 'stroke', _p4)
							},
							id: 0,
							shape: _user$project$Types$Rectangle(
								{
			...
			_0: _elm_lang$mouse$Mouse$downs(
				function (_p0) {
					return _user$project$Types$OnMouse(
						_user$project$Types$MouseDown(_p0));
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$ups(
					function (_p1) {
						return _user$project$Types$OnMouse(
							_user$project$Types$MouseUp(_p1));
					}),
				_1: {
					ctor: '::',
