...
var _user$project$Types$SVGSVGElement = F2(
	function (a, b) {
		return {size: a, elems: b};
	});
				...
				if (filter(_p2)) {
					...
					if (_p1.ctor === '::') {
						return {
							ctor: '::',
							_0: _p1._0,
							_1: A3(_user$project$Utils$replace, filter, _p1._1, _p3)
						};
					} else {
						var _v2 = filter,
							_v3 = {ctor: '[]'},
					...
					return {
						ctor: '::',
						_0: _p2,
						_1: A3(_user$project$Utils$replace, filter, replacer, _p3)
					};
				}
			} else {
				return {ctor: '[]'};
	...
	function (ident, model) {
		var loop = function (lst) {
			...
			while (true) {
				...
				if (_p4.ctor === '::') {
					var _p5 = _p4._0;
					if (_elm_lang$core$Native_Utils.eq(_p5.id, ident)) {
		...
		if (_p6.ctor === '::') {
			if (_p6._0.ctor === 'Just') {
				return {
					ctor: '::',
					_0: _p6._0._0,
					_1: _user$project$Utils$flatten(_p6._1)
				};
			} else {
				var _v8 = _p6._1;
				lst = _v8;
...
var _user$project$Utils$last = function (lst) {
	var len = _elm_lang$core$List$length(lst);
	var _p7 = A2(_elm_lang$core$List$drop, len - 1, lst);
					...
					if (_p2.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									svg: _elm_lang$core$Native_Utils.update(
										modelsvg,
										{elems: newElems})
								}),
							_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				...
				if (_p3.ctor === 'Nothing') {
					...
					if (_elm_lang$core$Native_Utils.eq(model.mode, _user$project$Types$HandMode)) {
						...
						var _p4 = _user$project$Utils$last(model.svg.elems);
						if (_p4.ctor === 'Nothing') {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						} else {
							var _p6 = _p4._0;
							var init = _user$project$Utils$init(model.svg.elems);
							var _p5 = _p6.shape;
							if (_p5.ctor === 'Rectangle') {
								var modelSvg = model.svg;
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
...
var _user$project$ViewBuilder$build = function (svg) {
	...
	if (_p2.ctor === 'Rectangle') {
								...
								_0: _elm_lang$svg$Svg_Attributes$style(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											svg.style.fill,
											A2(_elm_lang$core$Basics_ops['++'], ';stroke:', svg.style.stroke)))),
								_1: {
									ctor: '::',
									_0: _user$project$Utils$onItemMouseDown(
										function (_p3) {
											var _p4 = _p3;
											return A3(_user$project$Types$OnSelect, svg.id, _p4._0, _p4._1);
										}),
									_1: {ctor: '[]'}
								}
							}
		...
		var _p10 = _p2._0.size;
		var _p9 = _p2._0.center;
		var centx = _elm_lang$core$Tuple$first(_p9);
		var centy = _elm_lang$core$Tuple$second(_p9);
		var sizex = _elm_lang$core$Tuple$first(_p10);
		var sizey = _elm_lang$core$Tuple$second(_p10);
		return A2(
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$svg,
					{
						...
						_0: _elm_lang$svg$Svg_Attributes$width(
							_elm_lang$core$Basics$toString(
								_elm_lang$core$Tuple$first(model.svg.size))),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								_elm_lang$core$Basics$toString(
									_elm_lang$core$Tuple$second(model.svg.size))),
							_1: {
								ctor: '::',
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$map, _user$project$ViewBuilder$build, model.svg.elems),
